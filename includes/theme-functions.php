...
if ( !function_exists('woo_add_slides') ) {
	function woo_add_slides() {
		...
		$labels = array(
			'name' => _x( 'Slide Pages', 'taxonomy general name' ),
			'singular_name' => _x( 'Slide Pages', 'taxonomy singular name' ),
...
function woo_portfolio_image_dimensions ( $layout = 'one-col', $width = '960' ) {
	...
	$dimensions = array( 'width' => 500, 'height' => 0, 'thumb_width' => 150, 'thumb_height' => 150 );
	...
	switch ( $combo ) {
		...
		case 'one-col|1200px':
			...
			$dimensions = array( 'width' => 700, 'height' => 0, 'thumb_width' => 195, 'thumb_height' => 195 );
		
		break;
		
		case 'one-col|980px':
		
			$dimensions = array( 'width' => 530, 'height' => 0, 'thumb_width' => 150, 'thumb_height' => 150 );
		...
		case 'one-col|940px':
			...
			$dimensions = array( 'width' => 515, 'height' => 0, 'thumb_width' => 165, 'thumb_height' => 165 );
		
		break;
		
		case 'one-col|880px':
		
			$dimensions = array( 'width' => 480, 'height' => 0, 'thumb_width' => 150, 'thumb_height' => 150 );
		
		break;
		
		case 'one-col|760px':
		
			$dimensions = array( 'width' => 342, 'height' => 0, 'thumb_width' => 100, 'thumb_height' => 100 );
		
		break;
		
		// Two column.
		case 'two-col-left|1200px':
		case 'two-col-right|1200px':
		
			$dimensions = array( 'width' => 800, 'height' => 0, 'thumb_width' => 250, 'thumb_height' => 250 );
		
		break;
		
		case 'two-col-left|980px':
		case 'two-col-right|980px':
		
			$dimensions = array( 'width' => 650, 'height' => 0, 'thumb_width' => 190, 'thumb_height' => 190 );
		
		break;
		
		case 'two-col-left|960px':
		case 'two-col-right|960px':
		
			$dimensions = array( 'width' => 630, 'height' => 0, 'thumb_width' => 190, 'thumb_height' => 190 );
		
		break;
		
		case 'two-col-left|940px':
		case 'two-col-right|940px':
		
			$dimensions = array( 'width' => 610, 'height' => 0, 'thumb_width' => 180, 'thumb_height' => 180 );
		
		break;
		
		case 'two-col-left|880px':
		case 'two-col-right|880px':
		
			$dimensions = array( 'width' => 550, 'height' => 0, 'thumb_width' => 160, 'thumb_height' => 160 );
		
		break;
		
		case 'two-col-left|760px':
		case 'two-col-right|760px':
		
			$dimensions = array( 'width' => 480, 'height' => 0, 'thumb_width' => 145, 'thumb_height' => 145 );
		
		break;
		
		// Three column.
		case 'three-col-left|1200px':
		case 'three-col-middle|1200px':
		case 'three-col-right|1200px':
		
			$dimensions = array( 'width' => 680, 'height' => 0, 'thumb_width' => 200, 'thumb_height' => 200 );
		
		break;
		
		case 'three-col-left|980px':
		case 'three-col-middle|980px':
		case 'three-col-right|980px':
		
			$dimensions = array( 'width' => 480, 'height' => 0, 'thumb_width' => 140, 'thumb_height' => 140 );
		
		break;
		
		case 'three-col-left|960px':
		case 'three-col-middle|960px':
		case 'three-col-right|960px':
		
			$dimensions = array( 'width' => 460, 'height' => 0, 'thumb_width' => 146, 'thumb_height' => 146 );
		
		break;
		
		case 'three-col-left|940px':
		case 'three-col-middle|940px':
		case 'three-col-right|940px':
		
			$dimensions = array( 'width' => 440, 'height' => 0, 'thumb_width' => 130, 'thumb_height' => 130 );
		
		break;
		
		case 'three-col-left|880px':
		case 'three-col-middle|880px':
		case 'three-col-right|880px':
		
			$dimensions = array( 'width' => 420, 'height' => 0, 'thumb_width' => 120, 'thumb_height' => 120 );
		
		break;
		
		case 'three-col-left|760px':
		case 'three-col-middle|760px':
		case 'three-col-right|760px':
		
			$dimensions = array( 'width' => 350, 'height' => 0, 'thumb_width' => 100, 'thumb_height' => 100 );
			...
			foreach ( $query as $post ) {
				...
				if ( $args['display_author'] == true || $args['display_url'] == true ) {
					...
					if ( isset( $meta['feedback_url'] ) && ( $meta['feedback_url'][0] != '' ) && $args['display_url'] == true ) {
						$author .= '<a href="' . $meta['feedback_url'][0] . '" title="' . esc_attr( $author_text ) . '" class="feedback-url">' . $meta['feedback_url'][0] . '</a> &rarr;';
					}
				}
